...
kind-dev-setup: ## 🔧 개발 환경: 클러스터 생성 → ECR 이미지 사용 (외부 DB 사용)
	...
	@echo "  8. ArgoCD 설치"
	@echo "  9. ArgoCD Dev Applications 자동 배포"
	@echo ""
...
# 	@$(MAKE) helm-install-infra ENV=dev
	...
	@echo ""
	@echo "----------------------------------------------"
	@echo "  [9/9] ArgoCD Dev Applications 자동 배포"
	@echo "----------------------------------------------"
	@echo ""
	...
	@echo "    - ArgoCD (GitOps)"
	@echo "    - Dev Applications (ArgoCD 자동 배포)"
	@echo ""
	...
	@echo ""
	@echo "  🚀 ArgoCD가 자동으로 모든 서비스를 배포합니다!"
	@echo "     상태 확인: make argo-status"
	@echo ""
	@echo "  이후 개발 사이클:"
	@echo "    git push (k8s-deploy-dev) → ArgoCD 자동 감지 → 자동 배포"
	@echo ""
	@echo "=============================================="
